...
with st.sidebar:
    ...
    st.write("Le taux de pauvreté représente la part des ménages dont le revenu disponible est inférieur à 60% du niveau de vie médian en France. Le taux de pauvreté de la France est de 14,6% ")
